...
<div class="col-lg-4 sidebar">
  <div class="section">
    <div class="area">
        ...
        <div class="seasonswidget">
            <ul>
            <li v-for="genres in genre" ><router-link v-bind:to="{name:genres.taxonomy, params: { genre: genres.slug }}" v-html="genres.name"></router-link></li>
            </ul>
        </div>
    </div>
</div>
 <div class="section">
    <div class="area">
        ...
        <div class="seasonswidget">
            <ul>
            <li v-for="tipes in tipe" ><router-link v-bind:to="{name:tipes.taxonomy, params: { tipe: tipes.slug }}" v-html="tipes.name"></router-link></li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="seasonswidget">
            <ul>
                <li v-for="seasons in season">
                    <router-link v-bind:to="{name:seasons.taxonomy, params: { season: seasons.slug }}" v-html="seasons.name"></router-link>
            </li>
            </ul>
        </div>
    </div>
